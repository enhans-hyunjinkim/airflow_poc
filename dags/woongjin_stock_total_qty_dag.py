...
with DAG(
        "woongjin_stock_total_qty_dag",
        default_args=default_args,
        description="Woongjin Total Quantity DAG",
    ...
    transform_stock_data = StockJsonToMongoOperator(
        ...
        collection_name='woongjin__stock_total_quantity',
        exclude_fields=['fc_amt', 'rc_amt', 'recent28_days', 'stock_days', 'total_amt', 'vf_amt']
    )

    load_stock_data = MongoUpsertOperator(
        task_id='load_stock_data',
        conn_id='mongo_agent_ground',
        collection='woongjin__stock_total_quantity',
